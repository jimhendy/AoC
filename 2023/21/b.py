...
@nb.njit
def _location_in_original_grid(location: complex, grid_width: int, grid_height: int) -> complex:
    ...
    for step in [1j, -1j, 1, -1]:
        ...
        while True:
            ...
            if position in rocks:
                logger.error(f"Found rock at {position}. There is not a clear path to the edge of the grid in the direction {step}")
